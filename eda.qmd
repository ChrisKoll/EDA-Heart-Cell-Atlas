...
if (test_mode) {
  message("Script ran in TEST mode.")
}
```
...
if (test_mode) {
  # Test data
  path_to_data <- "test/adata_1000x1000_sample.h5ad"
} else {
 path_to_data <- "" 
}

file_name <- basename(path_to_data)
message(paste("File used for analysis:", file_name))
```
